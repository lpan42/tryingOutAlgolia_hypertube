      ...
      <Card className={classes.card}>
        <CardContent>
          ...
          <div className={classes.div}>
            ...
            <Button color='primary' onClick={auth42}>
              <img className={classes.logoImg} src={Logo42} alt='42' />
            </Button>
            <Button color='primary' onClick={authGoogle}>
              <img className={classes.logoImg} src={LogoGoogle} alt='Google' />
            </Button>
            <Button color='primary' onClick={authGithub}>
              <img className={classes.logoImg} src={LogoGithub} alt='Github' />
            </Button>
          </div>
          ...
          <Typography variant='subtitle2' color='secondary'>
            Forget you password?{" "}
            <Link to='resetpwd_request'>Reset My Password</Link>
          </Typography>
        </CardContent>
      </Card>
    </div>
