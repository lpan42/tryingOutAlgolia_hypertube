      ...
      <div className={classes.context}>
        ...
        <form className={classes.form} onSubmit={onSubmit}>
          ...
          <TextField
            ...
            onChange={(e) =>
              (user.data.firstname = e.target.value.toLowerCase())
            }
          />
          <TextField
            id='lastname'
            ...
            onChange={(e) =>
              (user.data.lastname = e.target.value.toLowerCase())
            }
          />
          <br></br>
          <TextField
            id='username'
            label={lang.account.username}
            style={{ width: 240 }}
            InputProps={{
              startAdornment: (
                <InputAdornment position='start'>
            ...
            onChange={(e) => {
              user.data.username = e.target.value.toLowerCase();
            }}
          />
          <br></br>
          <TextField
